...
/** \addtogroup APICaffe
    ...
    @{*/
#ifndef __APICAFFE_CONVERTER_BASE_H__
#define __APICAFFE_CONVERTER_BASE_H__

#include <iostream>
#include "LArCV/larcv_base.h"
#include "LArCV/Image2D.h"
namespace caffe {
  class Datum;
}
...
namespace larcv {
  ...
  namespace larcaffe {
    ...
    */
    class converter_base : public larcv::larcv_base {
    ...
    public:
      ...
      void copy_data(const Image2D& img);		     
